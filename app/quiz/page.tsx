...
import { hasCompletedQuestionnaire } from "@/lib/questionnaireLogic"
import { hasCompletedWizard, hasCompletedCVUpload } from "@/lib/profileProgress"
        ...
        <div className="min-h-screen">
            ...
            <div className="container max-w-4xl mx-auto px-4 py-8">
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground mt-0.5">Complete these steps to enhance your job matches</p>
                        </div>
                    </div>
                ...
                <div className="grid gap-6 mb-8">
                    ...
                    {/* If all cards are hidden, show a message */}
                    {!showQuestionnaire && !showWizard && !showCVUpload && (
                        <div className="text-center py-10 bg-muted/10 rounded-lg border border-border">
                            <Sparkles className="w-10 h-10 text-green-500 mx-auto mb-4" />
                            <h3 className="text-xl font-bold mb-2">All Set!</h3>
                            <p className="text-muted-foreground mb-4">You've completed all profile building steps.</p>
